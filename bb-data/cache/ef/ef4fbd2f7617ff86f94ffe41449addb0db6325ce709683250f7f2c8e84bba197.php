...
class __TwigTemplate_40d8a99d5ec38c841681c0c141105bfd20da9648bdd6fd3d4f2685172e93eff6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <select name=\"{{ name }}\" {% if required %}required=\"required\"{% endif%} class=\"form-control\">
...
{% endif %}
{% endmacro %}
", "macro_functions.phtml", "/home/lexcicxy/hostshibe.cf/bb-themes/bootstrap/html/macro_functions.phtml");
    }
}
